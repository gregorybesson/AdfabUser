    ...
    public function __construct($name = null, AuthenticationOptionsInterface $options, Translator $translator)
    {
        ...
        $this->add(array(
            ...
            'attributes' => array(
                'type' => 'email',
                'class' => 'large-input',
                'placeholder' => ($translator->translate('Email address', 'adfabuser')),
            ),
        ));
        ...
        $this->add(array(
            'name' => 'credential',
            'options' => array(
                'label' => ($translator->translate('Password', 'adfabuser')),
            ),
            'attributes' => array(
                'type' => 'password',
                'class' => 'large-input',
                'placeholder' => ($translator->translate('Password', 'adfabuser')),
            ),
        ));
