    ...
    ForgotOptionsInterface
{
     ...
     * @var string
     */
    protected $rememberMeEntityClass = 'AdfabUser\Entity\RememberMe';

    /**
     * @var string
     */
    protected $userEntityClass = 'AdfabUser\Entity\User';
    ...
    protected $userMapper = 'AdfabUser\Mapper\User';
     ...
     * @var string
     */
    protected $passwordEntityClass = 'AdfabUser\Entity\Password';
     ...
     * @return \Adfabuser\Options\ModuleOptions
     */
