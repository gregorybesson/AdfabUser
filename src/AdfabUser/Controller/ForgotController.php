...
use AdfabUser\Service\Password as PasswordService;
use AdfabUser\Options\ForgotControllerOptionsInterface;
...
class ForgotController extends AbstractActionController
{
    ...
    public function forgotAction()
    {
        ...
        if ( $this->getRequest()->isPost() ) {
            ...
            if ( $form->isValid() ) {
                ...
                $this->flashMessenger()->setNamespace('adfabuser-forgot-form')->addMessage($this->failedMessage);
    ...
    public function getPasswordService()
    {
        if (!$this->passwordService) {
            $this->passwordService = $this->getServiceLocator()->get('adfabuser_password_service');
        }
    ...
    {
        if (!$this->forgotForm) {
            $this->setForgotForm($this->getServiceLocator()->get('adfabuser_forgot_form'));
        }
    ...
    {
        if (!$this->resetForm) {
            $this->setResetForm($this->getServiceLocator()->get('adfabuser_reset_form'));
        }
